...
# Настройки бота
BOT_TOKEN = "Токен от @BotFather"  # Токен от @BotFather
API_ID = 1111111  # Ваш API ID от https://my.telegram.org/apps
API_HASH = "111"  # Ваш API Hash от https://my.telegram.org/apps
